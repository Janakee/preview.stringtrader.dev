            ...
            case 'checkbox':
                ...
                <ol class="checkboxes">
                    ...
                    ?>
                        ...
                        <li>
                            <input type="checkbox" name="<?php esc_attr_e($result->field_name); ?>_list" id="<?php esc_attr_e($result->field_name); echo '_'.$optionCursor++; ?>" value="<?php esc_attr_e($option); ?>" class="checkboxlist <?php if ($result->field_req) echo 'required' ?>" onclick="addRemoveCheckboxValues(this, '<?php esc_attr_e($result->field_name); ?>_value')">&nbsp;&nbsp;&nbsp;<?php echo trim(esc_attr($option)); ?>
                        </li> <!-- #checkbox -->
                    <?php
                    }
                    ?>

                    <input type="hidden" name="<?php esc_attr_e($result->field_name); ?>" id="<?php esc_attr_e($result->field_name); ?>_value" value="" style="display:none;" />
        ...
        <li>
            ...
            <div id="review">
                ...
                if ( $result->field_type == 'text area' )
                    echo stripslashes( nl2br( $_POST[ esc_html( $result->field_name ) ] ) );
                else
                    echo stripslashes( strip_tags( $_POST[ esc_html( $result->field_name ) ] ) ); 
                ?>
            ...
            <li>
            	<div class="labelwrapper">
                    ...
                    <?php foreach ( $results as $result ) { ?>
                            <option value="<?php esc_attr_e($result->pack_id); ?>"><?php esc_attr_e($result->pack_name); ?></option>
                    <?php } ?>
