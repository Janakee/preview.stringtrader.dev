...
Description: Originally developed by Don Benjamin, this plugin allows admin to build custom search form.  Allows the site admin to configure multiple html inputs for different fields including custom fields.  Also provides an extensible mechanism for integrating with other plugins data structures. <strong>Now working in ClassiPress version 3.0.5.x and 3.2.x</strong>
Version: 0.7
Author: alucas 
